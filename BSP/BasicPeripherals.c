...
static void Infrared_Config(void)
{
	GPIO_InitTypeDef	GPIO_InitStructure;
	...
	GPIO_ResetBits(GPIOE,GPIO_Pin_4|GPIO_Pin_5|GPIO_Pin_6|GPIO_Pin_12);
...
static void TIM3_Config(void)
{
	...
	NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = 0x04;  //设置抢占优先级为1
	NVIC_InitStructure.NVIC_IRQChannelSubPriority = 0;  //设置响应优先级为2
	NVIC_InitStructure.NVIC_IRQChannelCmd = ENABLE; 
	NVIC_Init(&NVIC_InitStructure);  
